  ...
  if bActive=true and life>0
  {
    ...
    else if atkSequence=4 //---------- Attack: Teleport Lightning ----------
    {
      ...
      else if atkTime>=20 and atkTime<=90 //Go to new location
      {
        ...
        if x<newLoc {x+=tMoveSpd/FPS_SCA}
        else {x-=tMoveSpd/FPS_SCA}
    ...
    if atkSequence=0 //Fall to the floor
    {
      if atkTime mod 5=0
      {
        ...
        for(i=0;i<6;i+=1)
        {
          ...
          tEffect.speed=5/FPS_SCA; tEffect.direction=random(360); tEffect.friction=0.1+random(0.3)
    ...
    else if atkSequence=2 //Fade away
    {
      if atkTime mod 2=0
      {
        ...
        for(i=0;i<5;i+=1)
        {
          ...
          tEffect.speed=6/FPS_SCA; tEffect.direction=80+random(20)
