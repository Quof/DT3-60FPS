  ...
  if bActive=true
  {
    ...
    else if atkProg=1 //Falling
    {
      if isCollisionBottom(1)
      {
        ...
        tEffect.sprite_index=sEfThwompHit; tEffect.image_speed=0.5/FPS_SCA
        tEffect.newBlend=-1; tEffect.followID=-1; tEffect.decay=-100; tEffect.xSpd=1/FPS_SCA; tEffect.ySpd=0
        tEffect=instance_create(x-12,bbox_bottom+2,oEffect)
        tEffect.sprite_index=sEfThwompHit; tEffect.image_xscale=-1; tEffect.image_speed=0.5/FPS_SCA
        tEffect.newBlend=-1; tEffect.followID=-1; tEffect.decay=-100; tEffect.xSpd=-1/FPS_SCA; tEffect.ySpd=0
        yVel=0
        y+=1
        atkProg+=1
