...
if global.gamePaused=false
{
  if global.gameProgress=30 and room=rMain_2 //Key tutorial
  {
    ...
    else if charDialogue[1]=2 {convo[1]+=1/FPS_SCA;if convo[1]>=100 {charDialogue[1]+=1; convo[1]=0}}
    else if charDialogue[1]=3
    {
      msgCreate(240,200,"Chao","I like it.",0,1,oMessagePerson,0)
      newMessage.fadingTime=60; charDialogue[1]+=1
    }
    else if charDialogue[1]=4 {convo[1]+=1/FPS_SCA;if convo[1]>=70 {charDialogue[1]+=1; convo[1]=0}}
    else if charDialogue[1]=5
    {
      msgCreate(240,200,"Jeremy","Figures.",0,1,oMessagePerson,0)
      newMessage.fadingTime=60; charDialogue[1]+=1
    }
    else if charDialogue[1]=6 {convo[1]+=1/FPS_SCA;if convo[1]>=70 {charDialogue[1]+=1; convo[1]=0}}
    else if charDialogue[1]=7
    {
      msgCreate(240,200,"Chao","Hmm?",0,1,oMessagePerson,0)
      newMessage.fadingTime=60; charDialogue[1]+=1
    }
    else if charDialogue[1]=8 {convo[1]+=1/FPS_SCA;if convo[1]>=70 {charDialogue[1]+=1; convo[1]=0}}
  ...
  else if global.gameProgress=40 and room=rMain_3 //Drop through platform tutorial
  {
    ...
    else if charDialogue[0]=1 {convo[0]+=1/FPS_SCA;if convo[0]>=130 {charDialogue[0]+=1; convo[0]=0}}
    else if charDialogue[0]=2
    {
  ...
  else if global.gameProgress=60 and room=rMain_4 //Useless banter (Jerry & Claire)
  {
    ...
    else if charDialogue[0]=1 {convo[0]+=1/FPS_SCA;if convo[0]>=90 {charDialogue[0]+=1; convo[0]=0}}
    else if charDialogue[0]=2
    {
      msgCreate(0,0,"Jerry","I KNOW!",0,1,oMessagePerson,0)
      newMessage.fadingTime=60; charDialogue[0]+=1
    }
    else if charDialogue[0]=3 {convo[0]+=1/FPS_SCA;if convo[0]>=70 {charDialogue[0]+=1; convo[0]=0}}
    ...
    else if charDialogue[1]=1 {convo[1]+=1/FPS_SCA;if convo[1]>=100 {charDialogue[1]+=1; convo[1]=0}}
  ...
  else if global.gameProgress=90 and room=rMain_5 //Turn back
  {
    ...
    else if charDialogue[0]=1 {convo[0]+=1/FPS_SCA;if convo[0]>=180 {charDialogue[0]+=1; convo[0]=0}}
    else if charDialogue[0]=2
    {
      msgCreate(0,0,"Jerry","What's going on?",0,1,oMessagePerson,0)
      newMessage.fadingTime=50; charDialogue[0]+=1
    }
    else if charDialogue[0]=3 {convo[0]+=1/FPS_SCA;if convo[0]>=60 {charDialogue[0]+=1; convo[0]=0}}
    else if charDialogue[0]=4
    {
