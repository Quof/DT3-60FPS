  ...
  if bActive=true and stunnedTime=0
  {
    ...
    else if annoyTime=annoyDelay+21 //Spew annoying shit at the player
    {
      ...
      for(i=0;i<4;i+=1)
      {
        ...
        if i=0
        {
          tNewFire.xVel=-1/FPS_SCA
          tNewFire.yVel=-4/FPS_SCA
          tNewFire.grav=0.1/FPS_SCA/FPS_SCA
        }
        else if i=1
        {
          tNewFire.xVel=1/FPS_SCA
        ...
        {
          tNewFire.xVel=-2.5/FPS_SCA
          tNewFire.yVel=-3/FPS_SCA
          tNewFire.grav=0.09/FPS_SCA/FPS_SCA
        }
        else if i=3
        {
          tNewFire.xVel=2.5/FPS_SCA
