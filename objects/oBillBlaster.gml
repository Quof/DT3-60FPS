      ...
      if findTargetX>=56
      {
        ...
        if shotTime=shotDelay-10
        {
          ...
          for(i=0;i<2;i+=1)
          {
            ...
            tEffect.sprite_index=sMMSmokeCloud; tEffect.image_speed=0.5; tEffect.ySpd=(-1-(i*0.5))/FPS_SCA
            tEffect.newBlend=-1; tEffect.followID=-1; tEffect.decay=-100/FPS_SCA; tEffect.xSpd=0
          }
        }
        if shotTime>=shotDelay
        {
          ...
          else {bBill.bulletSpeed=7.5/FPS_SCA}
          shotTime=0
        }
      }
    }
    else //Vertical shot
    {
      ...
      if findTargetY>=56
      {
        ...
        if shotTime=shotDelay-10
        {
          ...
          {
            tEffect=instance_create(x,y+8,oEffect)
            tEffect.sprite_index=sMMSmokeCloud; tEffect.image_speed=0.5/FPS_SCA; tEffect.ySpd=(-1-(i*0.5))/FPS_SCA
