...
chaoText="Interesting bit of somewhat irrelevant information. Back in the day, there was a Youtube LPer that said the word 'Podobo' a lot. Probably because he played so many Super Mario World hacks."
...
if global.gamePaused=false
{
  ...
  if bActive=true and rising>=0
  {
    ...
    y+=yVel
    if yVel>1/FPS_SCA and y>ystart
    {
      var tEffect;
